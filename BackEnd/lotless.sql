...
--
-- Host: localhost    Database: lotless
-- ------------------------------------------------------
...
CREATE TABLE `activitydetails` (
  ...
  `weightdecreased` decimal(7,3) NOT NULL,
  `numberofitemspicked` int(11) NOT NULL,
...
--
-- Table structure for table `shelfdetails`
--
...
CREATE TABLE `shelfdetails` (
  ...
  `totalweight` decimal(7,3) DEFAULT NULL,
  `numberofitems` int(11) DEFAULT NULL,
  PRIMARY KEY (`shelfid`),
  KEY `itemid` (`itemid`),
  CONSTRAINT `shelfdetails_ibfk_1` FOREIGN KEY (`itemid`) REFERENCES `itemdetails` (`itemid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `shelfdetails`
--
